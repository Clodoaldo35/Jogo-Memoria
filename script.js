// PARTE 1/4 - Elementos DOM, Configurações e Estado
...
function toggleTheme() {
    ...
    themeButton.textContent = gameState.darkMode ? '🌙' : '🌞';
...
function nextWord() {
    ...
    if (checkButton) {
        checkButton.style.backgroundColor = 'var(--button-bg)';
...
function handleWrongAnswer() {
    ...
    if (gameState.attempts >= 3) {
        ...
        checkButton.style.backgroundColor = 'var(--button-disabled)';
